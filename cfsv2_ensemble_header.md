...
```console
netcdf \2024-04-01_converted_filled_0 {
dimensions:
        time = 28 ;
        nhru = 2462 ;
variables:
...
// global attributes:
                ...
                :history = "2024_04_01_15_40_23 Original filec created  by gdptools package: https://code.usgs.gov/wma/nhgf/toolsteam/gdptools \n" ;
}
```
